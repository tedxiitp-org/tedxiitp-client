    ...
    <div className="flex flex-col w-full">
      <div className="relative w-[calc(100%+1rem)] sm:w-[calc(100%+3rem)] -mx-2 sm:-mx-6 -mt-4 mb-4 note_bg py-3 text-center flex justify-center items-center">
        <Link
          ...
          className="text-white px-6 py-2 rounded-full font-bold tracking-widest uppercase text-sm sm:text-base font-sans transition-colors shadow-[0_0_15px_rgba(220,38,38,0.6)] border border-red-500/50 hover:bg-red-600/20"
        >
          Tickets are live! Book your seat now
        </Link>
      </div>
      <HomeHero />
      <AboutTheTheme />
